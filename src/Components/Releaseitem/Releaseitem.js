    ...
    render() {
        ...
        return(
            <div className='release-card'>
                ...
                <a href={this.props.beatporturl}><img className='icon' src={bpicon} alt='beatport icon'/></a>
                <a href={this.props.soundcloudurl}><img className='icon' src={scicon} alt='soundcloud icon'/></a>
